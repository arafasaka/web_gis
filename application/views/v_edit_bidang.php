...
<?php foreach($bidang as $b){ ?>   	
	...
	<?php echo form_open_multipart('index.php/bidang/detail'); ?>
		...
		<div class="form-group">
            <textarea  class="form-control" name="bidang_keterangan" value="<?php echo $b->bidang_keterangan ?>" placeholder="Keterangan Bidang" required="required"></textarea>
        </div>
        <div>
        <img src="<?php echo base_url(); ?>assets/uploads/ <?php echo $detail->uploads;?>" width="90" height="60">
        </div>
		<div class="form-group">
