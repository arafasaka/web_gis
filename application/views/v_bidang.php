            ...
            <table class="table table-bordered">
                ...
                <tbody>
                        ...
                        <td>
                            ...
                            <a href='<?=base_url().'index.php/bidang/edit/' . $b->bidang_kode?>'   class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href='<?=base_url().'index.php/bidang/hapus/' . $b->bidang_kode?>' class='delete' title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                            </tr>
                        <?php } ?>
                </tbody>
